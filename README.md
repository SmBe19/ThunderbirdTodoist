...
You can also download the xpi file from [here](https://dl.smeanox.com/thunderbird-todoist-0.7.xpi). Open the add-ons page in Thunderbird and choose 'install from file'.
